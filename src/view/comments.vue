...
//          url: 'http://news-at.zhihu.com/api/4/story/' + _this.detailId + '/long-comments',
          url: 'http://47.52.146.247:8010/api/4/story/' + _this.detailId + '/long-comments',
          method: 'GET',
...
//          url: 'http://news-at.zhihu.com/api/4/story/' + _this.detailId + '/short-comments',
          url: 'http://47.52.146.247:8010/api/4/story/' + _this.detailId + '/short-comments',
          method: 'GET',
          callback: function (res) {
      ...
      getShortCommentsNext () {
        ...
        _this.loading = true
        ajax({
          url: 'http://47.52.146.247:8010/api/4/story/' + _this.detailId + '/short-comments/before/' + _this.id,
          method: 'GET',
          callback: function (res) {
